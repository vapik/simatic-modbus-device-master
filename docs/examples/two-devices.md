...
![example read](/docs/images/two-devices/example_read.png)
...
![example write](/docs/images/two-devices/example_write.png)

## Code
The main logic is located in the function block ***ModbusRtu_Master***

![example read](/docs/images/two-devices/ModbusRtu_Master.png)
![subroutines](/docs/images/two-devices/subroutines.png)
